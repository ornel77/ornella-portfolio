        ...
        <div className='md:flex gap-8 md:mt-16 mt-8'>
          ...
          <div className='md:w-full flex flex-col gap-6'>
            <p className='mt-6 md:mt-0'>
              This is an ongoing personal project. I am part of a musical band
              with my family, and we occasionally perform in Paris and London. I
              initiated the development of this website with the intention of
              showcasing our work to bar managers and potential venues.
            </p>
            <p>
              To facilitate the process of adding and managing songs and
              upcoming shows, I included an admin page that allows my family
            ...
            <div className='demo-code flex items-center justify-center gap-8 pb-4'>
              <div className='code'>
                <a
                  href='https://github.com/ornel77/spade-diamonds/tree/dev'
                  target='_blank'
                  rel='noreferrer'

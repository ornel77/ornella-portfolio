...
function Contact() {
  return (
    <section name="contact" className='bg-[#0A192F]  w-full h-screen flex items-center justify-center p-4'>
        <form action={import.meta.env.VITE_FORM_URL} method="POST" className="flex flex-col max-w-[600px] w-full">
            <div className="pb-8">
                <p className="text-4xl font-bold inline border-b-4 border-pink-600 text-gray-300">Contact</p>
                <p className="text-gray-300 py-4">Submit the form below or send me an email at ot@gmail.com</p>
            </div>
